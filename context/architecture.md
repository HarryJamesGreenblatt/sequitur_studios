...
| Casting · Actors | casting, character design, performance | **Directing** Ch. 18–20 *(abridged, `0017`)* — the performance layer | `CastingDirector` role · casting vocabulary (`crew/casting.py`) + `Character`/`Actor` entities (`cast.py`) · `ImageStudio` (candidate looks) | **role built — vocab (`0054`)** |
