...
| **Directing the Story** — Francis Glebas | Development / direction — **visual storytelling**: the story → image bridge (story spine, character objectives, clarity of staging, sequence/beat construction) | **Sourcing (`0041`)** — the *storytelling* half only (its storyboarding half is redundant with *Professional Storyboarding*). Supplements the **Director** + **Screenwriter**; **no new `crew/` module**. *(Folder `directing the story/` ≠ Rabiger's `directing/`.)* | *(pending delivery)* |
