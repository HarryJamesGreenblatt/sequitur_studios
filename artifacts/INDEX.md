...
| Production design | Art department — sets, costume, palette *concepts* | **Sourcing (`0041`)** — a dedicated production-design text (recommended: Rizzo, *The Art Direction Handbook*) to seat the **Production Designer** over `ImageStudio`; today only Directing Ch. 23 *(abridged, `0017`)* grounds it | *(pending delivery)* |
