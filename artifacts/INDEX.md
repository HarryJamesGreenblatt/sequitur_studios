...
| Production design | Art department — sets, costume, palette *concepts* | **Partly grounded:** Directing Ch. 23 (visual design) *(abridged, `0017`)*; a dedicated production-design source still planned *(color grading is now its own source, above)* | *(see [`directing/`](directing/INDEX.md))* |
