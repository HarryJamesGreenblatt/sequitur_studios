...
| **The Screenwriter's Taxonomy** — Eric R. Williams | Development — story: a genre/voice/pathway/POV *classification system* | **Imported · staged** (8 ch, `0015`); abridgement pending. Enum-friendly → a future `Screenwriter` role vocabulary | [`the screenwriter's taxonomy/`](the%20screenwriter's%20taxonomy/INDEX.md) |
| **Directing: Film Techniques and Aesthetics** — Rabiger & Hurbis-Cherrier, 6th ed. | Director-centric **spine** across plan→shoot→assemble→ship (dramaturgy, aesthetics, casting/actors, production process, post, delivery) | **Imported · staged** (28 curated ch, `0015`); abridgement pending. Grounds the **Director** role; secondary for many depts | [`directing/`](directing/INDEX.md) |
...
| Production design / color | Art department — sets, costume, grade | **Partly staged:** Directing Ch. 23 (visual design); dedicated design/color source still planned | *(see [`directing/`](directing/INDEX.md))* |
